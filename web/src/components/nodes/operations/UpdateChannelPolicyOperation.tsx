...
interface UpdateChannelPolicyOperationProps {
	index: number
	onRemove: () => void
	channelConfig?: any
}

export function UpdateChannelPolicyOperation({ index, onRemove, channelConfig }: UpdateChannelPolicyOperationProps) {
	...
	return (
		<Card>
			<CardHeader className="flex-row items-center justify-between space-y-0 pb-2">
				<CardTitle className="text-base font-medium">Update Channel Policy</CardTitle>
