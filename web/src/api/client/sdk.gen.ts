 ...
 */
export const postKeysByKeyIdSignData = <ThrowOnError extends boolean = false>(options: Options<PostKeysByKeyIdSignDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostKeysByKeyIdSignDataResponses, PostKeysByKeyIdSignDataErrors, ThrowOnError>({
 ...
 */
export const getDefaults = <ThrowOnError extends boolean = false>(options?: Options<GetDefaultsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetDefaultsResponses, GetDefaultsErrors, ThrowOnError>({
 ...
 */
export const deployPrometheus = <ThrowOnError extends boolean = false>(options: Options<DeployPrometheusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<DeployPrometheusResponses, DeployPrometheusErrors, ThrowOnError>({
        url: '/metrics/deploy',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const tailMetricsLogs = <ThrowOnError extends boolean = false>(options?: Options<TailMetricsLogsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<TailMetricsLogsResponses, TailMetricsLogsErrors, ThrowOnError>({
        url: '/metrics/logs',
        ...options
    });
};
 ...
 */
export const getNodeMetrics = <ThrowOnError extends boolean = false>(options: Options<GetNodeMetricsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodeMetricsResponses, GetNodeMetricsErrors, ThrowOnError>({
        url: '/metrics/node/{id}',
        ...options
    });
};
...
export const getLabelValues = <ThrowOnError extends boolean = false>(options: Options<GetLabelValuesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetLabelValuesResponses, GetLabelValuesErrors, ThrowOnError>({
        querySerializer: {
            array: {
                explode: false,
                style: 'form'
 ...
 */
export const customQuery = <ThrowOnError extends boolean = false>(options: Options<CustomQueryData, ThrowOnError>) => {
 ...
 */
export const getNodeMetricsRange = <ThrowOnError extends boolean = false>(options: Options<GetNodeMetricsRangeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodeMetricsRangeResponses, GetNodeMetricsRangeErrors, ThrowOnError>({
 ...
 */
export const checkPortAvailability = <ThrowOnError extends boolean = false>(options: Options<CheckPortAvailabilityData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CheckPortAvailabilityResponses, CheckPortAvailabilityErrors, ThrowOnError>({
 ...
 */
export const refreshPrometheus = <ThrowOnError extends boolean = false>(options: Options<RefreshPrometheusData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RefreshPrometheusResponses, RefreshPrometheusErrors, ThrowOnError>({
        url: '/metrics/refresh',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const reloadConfiguration = <ThrowOnError extends boolean = false>(options?: Options<ReloadConfigurationData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<ReloadConfigurationResponses, ReloadConfigurationErrors, ThrowOnError>({
        url: '/metrics/reload',
        ...options
    });
};
 ...
 */
export const startPrometheus = <ThrowOnError extends boolean = false>(options?: Options<StartPrometheusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<StartPrometheusResponses, StartPrometheusErrors, ThrowOnError>({
        url: '/metrics/start',
        ...options
    });
};
 ...
 */
export const stopPrometheus = <ThrowOnError extends boolean = false>(options?: Options<StopPrometheusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<StopPrometheusResponses, StopPrometheusErrors, ThrowOnError>({
        url: '/metrics/stop',
        ...options
    });
};
 ...
 */
export const undeployPrometheus = <ThrowOnError extends boolean = false>(options?: Options<UndeployPrometheusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<UndeployPrometheusResponses, UndeployPrometheusErrors, ThrowOnError>({
 ...
 */
export const getNetworksBesuByIdNodes = <ThrowOnError extends boolean = false>(options: Options<GetNetworksBesuByIdNodesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksBesuByIdNodesResponses, GetNetworksBesuByIdNodesErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricx = <ThrowOnError extends boolean = false>(options?: Options<GetNetworksFabricxData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetNetworksFabricxResponses, unknown, ThrowOnError>({
 ...
 */
export const postNetworksFabricx = <ThrowOnError extends boolean = false>(options: Options<PostNetworksFabricxData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNetworksFabricxResponses, PostNetworksFabricxErrors, ThrowOnError>({
        url: '/networks/fabricx',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteNetworksFabricxById = <ThrowOnError extends boolean = false>(options: Options<DeleteNetworksFabricxByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNetworksFabricxByIdResponses, unknown, ThrowOnError>({
 ...
 */
export const getNetworksFabricxById = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdResponses, unknown, ThrowOnError>({
        url: '/networks/fabricx/{id}',
        ...options
    });
};
 ...
 */
export const getNetworksFabricxByIdBlocks = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdBlocksData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdBlocksResponses, GetNetworksFabricxByIdBlocksErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdBlocksByBlockNum = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdBlocksByBlockNumData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdBlocksByBlockNumResponses, GetNetworksFabricxByIdBlocksByBlockNumErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdChainInfo = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdChainInfoData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdChainInfoResponses, GetNetworksFabricxByIdChainInfoErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdNamespacePolicies = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdNamespacePoliciesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdNamespacePoliciesResponses, GetNetworksFabricxByIdNamespacePoliciesErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdNamespaces = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdNamespacesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdNamespacesResponses, unknown, ThrowOnError>({
 ...
 */
export const postNetworksFabricxByIdNamespaces = <ThrowOnError extends boolean = false>(options: Options<PostNetworksFabricxByIdNamespacesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNetworksFabricxByIdNamespacesResponses, PostNetworksFabricxByIdNamespacesErrors, ThrowOnError>({
        url: '/networks/fabricx/{id}/namespaces',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const deleteNetworksFabricxByIdNamespacesByNamespaceId = <ThrowOnError extends boolean = false>(options: Options<DeleteNetworksFabricxByIdNamespacesByNamespaceIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNetworksFabricxByIdNamespacesByNamespaceIdResponses, DeleteNetworksFabricxByIdNamespacesByNamespaceIdErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdNodes = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdNodesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdNodesResponses, unknown, ThrowOnError>({
 ...
 */
export const postNetworksFabricxByIdNodesByNodeIdJoin = <ThrowOnError extends boolean = false>(options: Options<PostNetworksFabricxByIdNodesByNodeIdJoinData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNetworksFabricxByIdNodesByNodeIdJoinResponses, unknown, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdStateByNamespace = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdStateByNamespaceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdStateByNamespaceResponses, GetNetworksFabricxByIdStateByNamespaceErrors, ThrowOnError>({
 ...
 */
export const getNetworksFabricxByIdTransactionsByTxId = <ThrowOnError extends boolean = false>(options: Options<GetNetworksFabricxByIdTransactionsByTxIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNetworksFabricxByIdTransactionsByTxIdResponses, GetNetworksFabricxByIdTransactionsByTxIdErrors, ThrowOnError>({
 ...
 */
export const exportNetworkTemplate = <ThrowOnError extends boolean = false>(options: Options<ExportNetworkTemplateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ExportNetworkTemplateResponses, ExportNetworkTemplateErrors, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
 ...
 */
export const importNetworkFromTemplate = <ThrowOnError extends boolean = false>(options: Options<ImportNetworkFromTemplateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ImportNetworkFromTemplateResponses, ImportNetworkFromTemplateErrors, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
 ...
 */
export const validateTemplateImport = <ThrowOnError extends boolean = false>(options: Options<ValidateTemplateImportData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ValidateTemplateImportResponses, ValidateTemplateImportErrors, ThrowOnError>({
        security: [
            {
                scheme: 'basic',
                type: 'http'
 ...
 */
export const putNetworksByIdGenesis = <ThrowOnError extends boolean = false>(options: Options<PutNetworksByIdGenesisData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutNetworksByIdGenesisResponses, PutNetworksByIdGenesisErrors, ThrowOnError>({
 ...
 * List node groups
 */
export const getNodeGroups = <ThrowOnError extends boolean = false>(options?: Options<GetNodeGroupsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetNodeGroupsResponses, unknown, ThrowOnError>({
        url: '/node-groups',
        ...options
    });
};
 ...
 * Create a node group
 */
export const postNodeGroups = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsResponses, unknown, ThrowOnError>({
        url: '/node-groups',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 * Delete a node group
 */
export const deleteNodeGroupsById = <ThrowOnError extends boolean = false>(options: Options<DeleteNodeGroupsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNodeGroupsByIdResponses, unknown, ThrowOnError>({
        url: '/node-groups/{id}',
        ...options
    });
};
 ...
 * Get a node group
 */
export const getNodeGroupsById = <ThrowOnError extends boolean = false>(options: Options<GetNodeGroupsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodeGroupsByIdResponses, unknown, ThrowOnError>({
        url: '/node-groups/{id}',
        ...options
    });
};
 ...
 */
export const getNodeGroupsByIdChildren = <ThrowOnError extends boolean = false>(options: Options<GetNodeGroupsByIdChildrenData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodeGroupsByIdChildrenResponses, unknown, ThrowOnError>({
 ...
 */
export const postNodeGroupsByIdInit = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsByIdInitData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsByIdInitResponses, unknown, ThrowOnError>({
 ...
 */
export const deleteNodeGroupsByIdPostgresService = <ThrowOnError extends boolean = false>(options: Options<DeleteNodeGroupsByIdPostgresServiceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteNodeGroupsByIdPostgresServiceResponses, unknown, ThrowOnError>({
 ...
 */
export const putNodeGroupsByIdPostgresService = <ThrowOnError extends boolean = false>(options: Options<PutNodeGroupsByIdPostgresServiceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutNodeGroupsByIdPostgresServiceResponses, unknown, ThrowOnError>({
        url: '/node-groups/{id}/postgres-service',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const postNodeGroupsByIdRestart = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsByIdRestartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsByIdRestartResponses, unknown, ThrowOnError>({
 ...
 */
export const getNodeGroupsByIdServices = <ThrowOnError extends boolean = false>(options: Options<GetNodeGroupsByIdServicesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodeGroupsByIdServicesResponses, unknown, ThrowOnError>({
 ...
 */
export const postNodeGroupsByIdServicesPostgres = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsByIdServicesPostgresData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsByIdServicesPostgresResponses, unknown, ThrowOnError>({
 ...
 */
export const postNodeGroupsByIdStart = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsByIdStartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsByIdStartResponses, unknown, ThrowOnError>({
 ...
 */
export const postNodeGroupsByIdStop = <ThrowOnError extends boolean = false>(options: Options<PostNodeGroupsByIdStopData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodeGroupsByIdStopResponses, unknown, ThrowOnError>({
 ...
 */
export const getNodesReadinessBesu = <ThrowOnError extends boolean = false>(options?: Options<GetNodesReadinessBesuData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetNodesReadinessBesuResponses, unknown, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcAccounts = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcAccountsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcAccountsResponses, GetNodesByIdRpcAccountsErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBalance = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBalanceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBalanceResponses, GetNodesByIdRpcBalanceErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBlockByHash = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBlockByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBlockByHashResponses, GetNodesByIdRpcBlockByHashErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBlockByNumber = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBlockByNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBlockByNumberResponses, GetNodesByIdRpcBlockByNumberErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBlockNumber = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBlockNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBlockNumberResponses, GetNodesByIdRpcBlockNumberErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBlockTransactionCountByHash = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBlockTransactionCountByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBlockTransactionCountByHashResponses, GetNodesByIdRpcBlockTransactionCountByHashErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcBlockTransactionCountByNumber = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcBlockTransactionCountByNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcBlockTransactionCountByNumberResponses, GetNodesByIdRpcBlockTransactionCountByNumberErrors, ThrowOnError>({
 ...
 * Gets the chain ID
 */
export const getNodesByIdRpcChainId = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcChainIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcChainIdResponses, GetNodesByIdRpcChainIdErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcCode = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcCodeData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcCodeResponses, GetNodesByIdRpcCodeErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcFeeHistory = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcFeeHistoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcFeeHistoryResponses, GetNodesByIdRpcFeeHistoryErrors, ThrowOnError>({
 ...
 */
export const postNodesByIdRpcLogs = <ThrowOnError extends boolean = false>(options: Options<PostNodesByIdRpcLogsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodesByIdRpcLogsResponses, PostNodesByIdRpcLogsErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcPendingTransactions = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcPendingTransactionsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcPendingTransactionsResponses, GetNodesByIdRpcPendingTransactionsErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcProtocolVersion = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcProtocolVersionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcProtocolVersionResponses, GetNodesByIdRpcProtocolVersionErrors, ThrowOnError>({
 ...
 */
export const postNodesByIdRpcQbftDiscardValidatorVote = <ThrowOnError extends boolean = false>(options: Options<PostNodesByIdRpcQbftDiscardValidatorVoteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodesByIdRpcQbftDiscardValidatorVoteResponses, PostNodesByIdRpcQbftDiscardValidatorVoteErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcQbftPendingVotes = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcQbftPendingVotesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcQbftPendingVotesResponses, GetNodesByIdRpcQbftPendingVotesErrors, ThrowOnError>({
 ...
 */
export const postNodesByIdRpcQbftProposeValidatorVote = <ThrowOnError extends boolean = false>(options: Options<PostNodesByIdRpcQbftProposeValidatorVoteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostNodesByIdRpcQbftProposeValidatorVoteResponses, PostNodesByIdRpcQbftProposeValidatorVoteErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcQbftRequestTimeout = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcQbftRequestTimeoutData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcQbftRequestTimeoutResponses, GetNodesByIdRpcQbftRequestTimeoutErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcQbftSignerMetrics = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcQbftSignerMetricsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcQbftSignerMetricsResponses, GetNodesByIdRpcQbftSignerMetricsErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcQbftValidatorsByBlockHash = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcQbftValidatorsByBlockHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcQbftValidatorsByBlockHashResponses, GetNodesByIdRpcQbftValidatorsByBlockHashErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcQbftValidatorsByBlockNumber = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcQbftValidatorsByBlockNumberData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcQbftValidatorsByBlockNumberResponses, GetNodesByIdRpcQbftValidatorsByBlockNumberErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcStorage = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcStorageData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcStorageResponses, GetNodesByIdRpcStorageErrors, ThrowOnError>({
 ...
 * Gets sync status
 */
export const getNodesByIdRpcSyncing = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcSyncingData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcSyncingResponses, GetNodesByIdRpcSyncingErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcTransactionByBlockHashAndIndex = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcTransactionByBlockHashAndIndexData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcTransactionByBlockHashAndIndexResponses, GetNodesByIdRpcTransactionByBlockHashAndIndexErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcTransactionByBlockNumberAndIndex = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcTransactionByBlockNumberAndIndexData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcTransactionByBlockNumberAndIndexResponses, GetNodesByIdRpcTransactionByBlockNumberAndIndexErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcTransactionByHash = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcTransactionByHashData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcTransactionByHashResponses, GetNodesByIdRpcTransactionByHashErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcTransactionCount = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcTransactionCountData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcTransactionCountResponses, GetNodesByIdRpcTransactionCountErrors, ThrowOnError>({
 ...
 */
export const getNodesByIdRpcTransactionReceipt = <ThrowOnError extends boolean = false>(options: Options<GetNodesByIdRpcTransactionReceiptData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetNodesByIdRpcTransactionReceiptResponses, GetNodesByIdRpcTransactionReceiptErrors, ThrowOnError>({
...
export const getServices = <ThrowOnError extends boolean = false>(options?: Options<GetServicesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetServicesResponses, unknown, ThrowOnError>({
        url: '/services',
        ...options
    });
};
 ...
 */
export const postServicesPostgres = <ThrowOnError extends boolean = false>(options: Options<PostServicesPostgresData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostServicesPostgresResponses, unknown, ThrowOnError>({
 ...
 * Delete a service
 */
export const deleteServicesById = <ThrowOnError extends boolean = false>(options: Options<DeleteServicesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteServicesByIdResponses, unknown, ThrowOnError>({
        url: '/services/{id}',
        ...options
    });
};
 ...
 * Get a service
 */
export const getServicesById = <ThrowOnError extends boolean = false>(options: Options<GetServicesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetServicesByIdResponses, unknown, ThrowOnError>({
        url: '/services/{id}',
        ...options
    });
};
 ...
 * Update a service
 */
export const putServicesById = <ThrowOnError extends boolean = false>(options: Options<PutServicesByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutServicesByIdResponses, unknown, ThrowOnError>({
        url: '/services/{id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const getServicesByIdConsumers = <ThrowOnError extends boolean = false>(options: Options<GetServicesByIdConsumersData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetServicesByIdConsumersResponses, unknown, ThrowOnError>({
 ...
 */
export const getServicesByIdLogs = <ThrowOnError extends boolean = false>(options: Options<GetServicesByIdLogsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetServicesByIdLogsResponses, unknown, ThrowOnError>({
 ...
 */
export const postServicesByIdPostgresDatabases = <ThrowOnError extends boolean = false>(options: Options<PostServicesByIdPostgresDatabasesData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostServicesByIdPostgresDatabasesResponses, unknown, ThrowOnError>({
...
export const postServicesByIdStart = <ThrowOnError extends boolean = false>(options: Options<PostServicesByIdStartData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostServicesByIdStartResponses, unknown, ThrowOnError>({
...
export const postServicesByIdStop = <ThrowOnError extends boolean = false>(options: Options<PostServicesByIdStopData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostServicesByIdStopResponses, unknown, ThrowOnError>({
