 ...
 */
export const getMetricsDefaults = <ThrowOnError extends boolean = false>(options?: Options<GetMetricsDefaultsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetMetricsDefaultsResponses, GetMetricsDefaultsErrors, ThrowOnError>({
 ...
 */
export const getMetricsLogs = <ThrowOnError extends boolean = false>(options?: Options<GetMetricsLogsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetMetricsLogsResponses, GetMetricsLogsErrors, ThrowOnError>({
        url: '/metrics/logs',
        ...options
    });
};
 ...
 */
export const getMetricsPortByPortCheck = <ThrowOnError extends boolean = false>(options: Options<GetMetricsPortByPortCheckData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMetricsPortByPortCheckResponses, GetMetricsPortByPortCheckErrors, ThrowOnError>({
 ...
 */
export const postMetricsRefresh = <ThrowOnError extends boolean = false>(options: Options<PostMetricsRefreshData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostMetricsRefreshResponses, PostMetricsRefreshErrors, ThrowOnError>({
        url: '/metrics/refresh',
        ...options,
        headers: {
            'Content-Type': 'application/json',
 ...
 */
export const postMetricsStart = <ThrowOnError extends boolean = false>(options?: Options<PostMetricsStartData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostMetricsStartResponses, PostMetricsStartErrors, ThrowOnError>({
        url: '/metrics/start',
        ...options
    });
};
 ...
 */
export const postMetricsStop = <ThrowOnError extends boolean = false>(options?: Options<PostMetricsStopData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostMetricsStopResponses, PostMetricsStopErrors, ThrowOnError>({
        url: '/metrics/stop',
        ...options
    });
};
