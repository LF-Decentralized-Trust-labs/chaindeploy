...
export const getDefaultsQueryKey = (options?: Options<GetDefaultsData>) => createQueryKey('getDefaults', options);
 ...
 */
export const getDefaultsOptions = (options?: Options<GetDefaultsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getDefaultsQueryKey(options)
    });
};

export const deployPrometheusQueryKey = (options: Options<DeployPrometheusData>) => createQueryKey('deployPrometheus', options);

/**
 * Deploy a new Prometheus instance
 * Deploys a new Prometheus instance with the specified configuration
 */
export const deployPrometheusOptions = (options: Options<DeployPrometheusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await deployPrometheus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: deployPrometheusQueryKey(options)
    });
};
 ...
 * Deploys a new Prometheus instance with the specified configuration
 */
export const deployPrometheusMutation = (options?: Partial<Options<DeployPrometheusData>>): UseMutationOptions<DeployPrometheusResponse, DeployPrometheusError, Options<DeployPrometheusData>> => {
    const mutationOptions: UseMutationOptions<DeployPrometheusResponse, DeployPrometheusError, Options<DeployPrometheusData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deployPrometheus({
                ...options,
                ...localOptions,
...
export const tailMetricsLogsQueryKey = (options?: Options<TailMetricsLogsData>) => createQueryKey('tailMetricsLogs', options);

/**
 * Tail Prometheus logs
 * Streams Prometheus logs with optional tail and follow functionality
 */
export const tailMetricsLogsOptions = (options?: Options<TailMetricsLogsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await tailMetricsLogs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tailMetricsLogsQueryKey(options)
    });
};

export const getNodeMetricsQueryKey = (options: Options<GetNodeMetricsData>) => createQueryKey('getNodeMetrics', options);

/**
 * Get metrics for a specific node
 * Retrieves metrics for a specific node by ID and optional PromQL query
 */
export const getNodeMetricsOptions = (options: Options<GetNodeMetricsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getNodeMetricsQueryKey(options)
    });
};

export const getLabelValuesQueryKey = (options: Options<GetLabelValuesData>) => createQueryKey('getLabelValues', options);
 ...
 */
export const getLabelValuesOptions = (options: Options<GetLabelValuesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getLabelValues({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getLabelValuesQueryKey(options)
    });
};

export const customQueryQueryKey = (options: Options<CustomQueryData>) => createQueryKey('customQuery', options);

/**
 * Execute custom Prometheus query
 * Execute a custom Prometheus query with optional time range
 */
export const customQueryOptions = (options: Options<CustomQueryData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: customQueryQueryKey(options)
    });
};

export const customQueryInfiniteQueryKey = (options: Options<CustomQueryData>): QueryKey<Options<CustomQueryData>> => createQueryKey('customQuery', options, true);

/**
 * Execute custom Prometheus query
 * Execute a custom Prometheus query with optional time range
 */
export const customQueryInfiniteOptions = (options: Options<CustomQueryData>) => {
    return infiniteQueryOptions<CustomQueryResponse, CustomQueryError, InfiniteData<CustomQueryResponse>, QueryKey<Options<CustomQueryData>>, string | Pick<QueryKey<Options<CustomQueryData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<CustomQueryData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                body: {
                    start: pageParam
                }
            };
        ...
        queryKey: customQueryInfiniteQueryKey(options)
    });
};
 ...
 * Execute a custom Prometheus query with optional time range
 */
export const customQueryMutation = (options?: Partial<Options<CustomQueryData>>): UseMutationOptions<CustomQueryResponse, CustomQueryError, Options<CustomQueryData>> => {
    const mutationOptions: UseMutationOptions<CustomQueryResponse, CustomQueryError, Options<CustomQueryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await customQuery({
                ...options,
                ...localOptions,
...
export const getNodeMetricsRangeQueryKey = (options: Options<GetNodeMetricsRangeData>) => createQueryKey('getNodeMetricsRange', options);

/**
 * Get metrics for a specific node with time range
 * Retrieves metrics for a specific node within a specified time range
 */
export const getNodeMetricsRangeOptions = (options: Options<GetNodeMetricsRangeData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNodeMetricsRange({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNodeMetricsRangeQueryKey(options)
    });
};

export const getNodeMetricsRangeInfiniteQueryKey = (options: Options<GetNodeMetricsRangeData>): QueryKey<Options<GetNodeMetricsRangeData>> => createQueryKey('getNodeMetricsRange', options, true);

/**
 * Get metrics for a specific node with time range
 * Retrieves metrics for a specific node within a specified time range
 */
export const getNodeMetricsRangeInfiniteOptions = (options: Options<GetNodeMetricsRangeData>) => {
    return infiniteQueryOptions<GetNodeMetricsRangeResponse, GetNodeMetricsRangeError, InfiniteData<GetNodeMetricsRangeResponse>, QueryKey<Options<GetNodeMetricsRangeData>>, string | Pick<QueryKey<Options<GetNodeMetricsRangeData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<GetNodeMetricsRangeData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    start: pageParam
                }
            };
        ...
        queryKey: getNodeMetricsRangeInfiniteQueryKey(options)
    });
};

export const checkPortAvailabilityQueryKey = (options: Options<CheckPortAvailabilityData>) => createQueryKey('checkPortAvailability', options);

/**
 * Check port availability
 * Checks if a specific port is available for Prometheus deployment
 */
export const checkPortAvailabilityOptions = (options: Options<CheckPortAvailabilityData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await checkPortAvailability({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: checkPortAvailabilityQueryKey(options)
    });
};

export const refreshPrometheusQueryKey = (options: Options<RefreshPrometheusData>) => createQueryKey('refreshPrometheus', options);

/**
 * Refresh Prometheus deployment
 * Refreshes the Prometheus deployment with new configuration parameters
 */
export const refreshPrometheusOptions = (options: Options<RefreshPrometheusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await refreshPrometheus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: refreshPrometheusQueryKey(options)
    });
};
 ...
 * Refreshes the Prometheus deployment with new configuration parameters
 */
export const refreshPrometheusMutation = (options?: Partial<Options<RefreshPrometheusData>>): UseMutationOptions<RefreshPrometheusResponse, RefreshPrometheusError, Options<RefreshPrometheusData>> => {
    const mutationOptions: UseMutationOptions<RefreshPrometheusResponse, RefreshPrometheusError, Options<RefreshPrometheusData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await refreshPrometheus({
                ...options,
                ...localOptions,
...
export const reloadConfigurationQueryKey = (options?: Options<ReloadConfigurationData>) => createQueryKey('reloadConfiguration', options);

/**
 * Reload Prometheus configuration
 * Triggers a reload of the Prometheus configuration to pick up any changes
 */
export const reloadConfigurationOptions = (options?: Options<ReloadConfigurationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await reloadConfiguration({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: reloadConfigurationQueryKey(options)
    });
};
 ...
 * Triggers a reload of the Prometheus configuration to pick up any changes
 */
export const reloadConfigurationMutation = (options?: Partial<Options<ReloadConfigurationData>>): UseMutationOptions<ReloadConfigurationResponse, ReloadConfigurationError, Options<ReloadConfigurationData>> => {
    const mutationOptions: UseMutationOptions<ReloadConfigurationResponse, ReloadConfigurationError, Options<ReloadConfigurationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await reloadConfiguration({
                ...options,
                ...localOptions,
...
export const startPrometheusQueryKey = (options?: Options<StartPrometheusData>) => createQueryKey('startPrometheus', options);

/**
 * Start Prometheus instance
 * Starts the Prometheus instance if it's currently stopped
 */
export const startPrometheusOptions = (options?: Options<StartPrometheusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await startPrometheus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: startPrometheusQueryKey(options)
    });
};
 ...
 * Starts the Prometheus instance if it's currently stopped
 */
export const startPrometheusMutation = (options?: Partial<Options<StartPrometheusData>>): UseMutationOptions<StartPrometheusResponse, StartPrometheusError, Options<StartPrometheusData>> => {
    const mutationOptions: UseMutationOptions<StartPrometheusResponse, StartPrometheusError, Options<StartPrometheusData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await startPrometheus({
                ...options,
                ...localOptions,
...
export const stopPrometheusQueryKey = (options?: Options<StopPrometheusData>) => createQueryKey('stopPrometheus', options);

/**
 * Stop Prometheus instance
 * Stops the Prometheus instance if it's currently running
 */
export const stopPrometheusOptions = (options?: Options<StopPrometheusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await stopPrometheus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: stopPrometheusQueryKey(options)
    });
};
 ...
 * Stops the Prometheus instance if it's currently running
 */
export const stopPrometheusMutation = (options?: Partial<Options<StopPrometheusData>>): UseMutationOptions<StopPrometheusResponse, StopPrometheusError, Options<StopPrometheusData>> => {
    const mutationOptions: UseMutationOptions<StopPrometheusResponse, StopPrometheusError, Options<StopPrometheusData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await stopPrometheus({
                ...options,
                ...localOptions,
...
export const undeployPrometheusQueryKey = (options?: Options<UndeployPrometheusData>) => createQueryKey('undeployPrometheus', options);

/**
 * Undeploy Prometheus instance
 * Stops and removes the Prometheus instance
 */
export const undeployPrometheusOptions = (options?: Options<UndeployPrometheusData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await undeployPrometheus({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: undeployPrometheusQueryKey(options)
    });
};
 ...
 * Stops and removes the Prometheus instance
 */
export const undeployPrometheusMutation = (options?: Partial<Options<UndeployPrometheusData>>): UseMutationOptions<UndeployPrometheusResponse, UndeployPrometheusError, Options<UndeployPrometheusData>> => {
    const mutationOptions: UseMutationOptions<UndeployPrometheusResponse, UndeployPrometheusError, Options<UndeployPrometheusData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await undeployPrometheus({
                ...options,
                ...localOptions,
...
export const getNetworksBesuByIdNodesQueryKey = (options: Options<GetNetworksBesuByIdNodesData>) => createQueryKey('getNetworksBesuByIdNodes', options);

/**
 * Get nodes for a Besu network
 * Retrieves all nodes associated with a Besu network
 */
export const getNetworksBesuByIdNodesOptions = (options: Options<GetNetworksBesuByIdNodesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksBesuByIdNodes({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksBesuByIdNodesQueryKey(options)
    });
};
...
export const getNetworksFabricxQueryKey = (options?: Options<GetNetworksFabricxData>) => createQueryKey('getNetworksFabricx', options);

/**
 * List FabricX networks
 */
export const getNetworksFabricxOptions = (options?: Options<GetNetworksFabricxData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricx({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxQueryKey(options)
    });
};

export const postNetworksFabricxQueryKey = (options: Options<PostNetworksFabricxData>) => createQueryKey('postNetworksFabricx', options);

/**
 * Create a FabricX network
 * Creates a FabricX network and generates the Arma-consensus genesis block from the referenced orderer-group nodes. The nodes must already be created (certs/config generated) but not yet started.
 */
export const postNetworksFabricxOptions = (options: Options<PostNetworksFabricxData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNetworksFabricx({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNetworksFabricxQueryKey(options)
    });
};
 ...
 * Creates a FabricX network and generates the Arma-consensus genesis block from the referenced orderer-group nodes. The nodes must already be created (certs/config generated) but not yet started.
 */
export const postNetworksFabricxMutation = (options?: Partial<Options<PostNetworksFabricxData>>): UseMutationOptions<PostNetworksFabricxResponse, PostNetworksFabricxError, Options<PostNetworksFabricxData>> => {
    const mutationOptions: UseMutationOptions<PostNetworksFabricxResponse, PostNetworksFabricxError, Options<PostNetworksFabricxData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNetworksFabricx({
                ...options,
                ...localOptions,
...
/**
 * Delete a FabricX network
 */
export const deleteNetworksFabricxByIdMutation = (options?: Partial<Options<DeleteNetworksFabricxByIdData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteNetworksFabricxByIdData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteNetworksFabricxByIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteNetworksFabricxById({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getNetworksFabricxByIdQueryKey = (options: Options<GetNetworksFabricxByIdData>) => createQueryKey('getNetworksFabricxById', options);

/**
 * Get a FabricX network by ID
 */
export const getNetworksFabricxByIdOptions = (options: Options<GetNetworksFabricxByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdQueryKey(options)
    });
};

export const getNetworksFabricxByIdBlocksQueryKey = (options: Options<GetNetworksFabricxByIdBlocksData>) => createQueryKey('getNetworksFabricxByIdBlocks', options);

/**
 * List FabricX blocks
 * Returns a paginated list of blocks by calling BlockQueryService.GetBlockByNumber against the committer sidecar. Latest-first when reverse=true.
 */
export const getNetworksFabricxByIdBlocksOptions = (options: Options<GetNetworksFabricxByIdBlocksData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdBlocks({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdBlocksQueryKey(options)
    });
};

export const getNetworksFabricxByIdBlocksInfiniteQueryKey = (options: Options<GetNetworksFabricxByIdBlocksData>): QueryKey<Options<GetNetworksFabricxByIdBlocksData>> => createQueryKey('getNetworksFabricxByIdBlocks', options, true);

/**
 * List FabricX blocks
 * Returns a paginated list of blocks by calling BlockQueryService.GetBlockByNumber against the committer sidecar. Latest-first when reverse=true.
 */
export const getNetworksFabricxByIdBlocksInfiniteOptions = (options: Options<GetNetworksFabricxByIdBlocksData>) => {
    return infiniteQueryOptions<GetNetworksFabricxByIdBlocksResponse, GetNetworksFabricxByIdBlocksError, InfiniteData<GetNetworksFabricxByIdBlocksResponse>, QueryKey<Options<GetNetworksFabricxByIdBlocksData>>, number | Pick<QueryKey<Options<GetNetworksFabricxByIdBlocksData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<GetNetworksFabricxByIdBlocksData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: getNetworksFabricxByIdBlocksInfiniteQueryKey(options)
    });
};

export const getNetworksFabricxByIdBlocksByBlockNumQueryKey = (options: Options<GetNetworksFabricxByIdBlocksByBlockNumData>) => createQueryKey('getNetworksFabricxByIdBlocksByBlockNum', options);

/**
 * Get a FabricX block
 * Returns a fully decoded block (with tx headers) by calling BlockQueryService.GetBlockByNumber.
 */
export const getNetworksFabricxByIdBlocksByBlockNumOptions = (options: Options<GetNetworksFabricxByIdBlocksByBlockNumData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdBlocksByBlockNum({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdBlocksByBlockNumQueryKey(options)
    });
};

export const getNetworksFabricxByIdChainInfoQueryKey = (options: Options<GetNetworksFabricxByIdChainInfoData>) => createQueryKey('getNetworksFabricxByIdChainInfo', options);

/**
 * Get FabricX chain info
 * Returns ledger height for a FabricX network by calling the committer sidecar's BlockQueryService.GetBlockchainInfo.
 */
export const getNetworksFabricxByIdChainInfoOptions = (options: Options<GetNetworksFabricxByIdChainInfoData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdChainInfo({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdChainInfoQueryKey(options)
    });
};

export const getNetworksFabricxByIdNamespacePoliciesQueryKey = (options: Options<GetNetworksFabricxByIdNamespacePoliciesData>) => createQueryKey('getNetworksFabricxByIdNamespacePolicies', options);

/**
 * List FabricX namespace policies
 * Returns the on-chain namespace policies from the committer query-service. These are the authoritative namespaces on the channel (distinct from the local namespace creation records).
 */
export const getNetworksFabricxByIdNamespacePoliciesOptions = (options: Options<GetNetworksFabricxByIdNamespacePoliciesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdNamespacePolicies({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdNamespacePoliciesQueryKey(options)
    });
};

export const getNetworksFabricxByIdNamespacesQueryKey = (options: Options<GetNetworksFabricxByIdNamespacesData>) => createQueryKey('getNetworksFabricxByIdNamespaces', options);

/**
 * List FabricX namespaces (merged chain + DB view)
 * Returns the merged view of namespaces for a FabricX network. The chain is the source of truth for existence and version (queried live from the committer query-service via GetNamespacePolicies); the local DB adds submission metadata (submitter, txId, pending/failed attempts). Rows carry source ∈ {chain, db, both}. If the committer is unreachable, chainError is set and only DB rows are returned.
 */
export const getNetworksFabricxByIdNamespacesOptions = (options: Options<GetNetworksFabricxByIdNamespacesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdNamespaces({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdNamespacesQueryKey(options)
    });
};

export const postNetworksFabricxByIdNamespacesQueryKey = (options: Options<PostNetworksFabricxByIdNamespacesData>) => createQueryKey('postNetworksFabricxByIdNamespaces', options);

/**
 * Create a FabricX namespace
 * Creates (or updates) a namespace within a FabricX channel by broadcasting a signed applicationpb.Tx to the channel's orderer router. Requires an existing network whose orderer group is running.
 */
export const postNetworksFabricxByIdNamespacesOptions = (options: Options<PostNetworksFabricxByIdNamespacesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNetworksFabricxByIdNamespaces({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNetworksFabricxByIdNamespacesQueryKey(options)
    });
};
 ...
 * Creates (or updates) a namespace within a FabricX channel by broadcasting a signed applicationpb.Tx to the channel's orderer router. Requires an existing network whose orderer group is running.
 */
export const postNetworksFabricxByIdNamespacesMutation = (options?: Partial<Options<PostNetworksFabricxByIdNamespacesData>>): UseMutationOptions<PostNetworksFabricxByIdNamespacesResponse, PostNetworksFabricxByIdNamespacesError, Options<PostNetworksFabricxByIdNamespacesData>> => {
    const mutationOptions: UseMutationOptions<PostNetworksFabricxByIdNamespacesResponse, PostNetworksFabricxByIdNamespacesError, Options<PostNetworksFabricxByIdNamespacesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNetworksFabricxByIdNamespaces({
                ...options,
                ...localOptions,
...
/**
 * Delete a FabricX namespace record (local only)
 * Removes the local database record for the namespace. On-chain the namespace is not removed — FabricX supports only namespace updates, not deletion.
 */
export const deleteNetworksFabricxByIdNamespacesByNamespaceIdMutation = (options?: Partial<Options<DeleteNetworksFabricxByIdNamespacesByNamespaceIdData>>): UseMutationOptions<unknown, DeleteNetworksFabricxByIdNamespacesByNamespaceIdError, Options<DeleteNetworksFabricxByIdNamespacesByNamespaceIdData>> => {
    const mutationOptions: UseMutationOptions<unknown, DeleteNetworksFabricxByIdNamespacesByNamespaceIdError, Options<DeleteNetworksFabricxByIdNamespacesByNamespaceIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteNetworksFabricxByIdNamespacesByNamespaceId({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getNetworksFabricxByIdNodesQueryKey = (options: Options<GetNetworksFabricxByIdNodesData>) => createQueryKey('getNetworksFabricxByIdNodes', options);

/**
 * Get nodes of a FabricX network
 */
export const getNetworksFabricxByIdNodesOptions = (options: Options<GetNetworksFabricxByIdNodesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdNodes({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdNodesQueryKey(options)
    });
};

export const postNetworksFabricxByIdNodesByNodeIdJoinQueryKey = (options: Options<PostNetworksFabricxByIdNodesByNodeIdJoinData>) => createQueryKey('postNetworksFabricxByIdNodesByNodeIdJoin', options);

/**
 * Join a FabricX node to a network (stage 2)
 * Writes the network genesis block into the node's config dirs and starts the node. The node must already be created and initialized (stage 1), and the network must already have its genesis block.
 */
export const postNetworksFabricxByIdNodesByNodeIdJoinOptions = (options: Options<PostNetworksFabricxByIdNodesByNodeIdJoinData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNetworksFabricxByIdNodesByNodeIdJoin({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNetworksFabricxByIdNodesByNodeIdJoinQueryKey(options)
    });
};
 ...
 * Writes the network genesis block into the node's config dirs and starts the node. The node must already be created and initialized (stage 1), and the network must already have its genesis block.
 */
export const postNetworksFabricxByIdNodesByNodeIdJoinMutation = (options?: Partial<Options<PostNetworksFabricxByIdNodesByNodeIdJoinData>>): UseMutationOptions<PostNetworksFabricxByIdNodesByNodeIdJoinResponse, DefaultError, Options<PostNetworksFabricxByIdNodesByNodeIdJoinData>> => {
    const mutationOptions: UseMutationOptions<PostNetworksFabricxByIdNodesByNodeIdJoinResponse, DefaultError, Options<PostNetworksFabricxByIdNodesByNodeIdJoinData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNetworksFabricxByIdNodesByNodeIdJoin({
                ...options,
                ...localOptions,
...
export const getNetworksFabricxByIdStateByNamespaceQueryKey = (options: Options<GetNetworksFabricxByIdStateByNamespaceData>) => createQueryKey('getNetworksFabricxByIdStateByNamespace', options);

/**
 * Query FabricX namespace state
 * Queries specific keys within a namespace via the committer query-service GetRows. FabricX does not expose a full scan, so the keys parameter is required and comma-separated.
 */
export const getNetworksFabricxByIdStateByNamespaceOptions = (options: Options<GetNetworksFabricxByIdStateByNamespaceData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdStateByNamespace({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdStateByNamespaceQueryKey(options)
    });
};

export const getNetworksFabricxByIdTransactionsByTxIdQueryKey = (options: Options<GetNetworksFabricxByIdTransactionsByTxIdData>) => createQueryKey('getNetworksFabricxByIdTransactionsByTxId', options);

/**
 * Get a FabricX transaction
 * Returns a decoded transaction envelope (type, timestamp, namespaces, endorsers) by calling BlockQueryService.GetTxByID against the committer sidecar.
 */
export const getNetworksFabricxByIdTransactionsByTxIdOptions = (options: Options<GetNetworksFabricxByIdTransactionsByTxIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNetworksFabricxByIdTransactionsByTxId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNetworksFabricxByIdTransactionsByTxIdQueryKey(options)
    });
};

export const exportNetworkTemplateQueryKey = (options: Options<ExportNetworkTemplateData>) => createQueryKey('exportNetworkTemplate', options);

/**
 * Export network as template
 * Export a network's configuration as a reusable template that can be imported to create similar networks. Supports both Fabric and Besu platforms.
 */
export const exportNetworkTemplateOptions = (options: Options<ExportNetworkTemplateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await exportNetworkTemplate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: exportNetworkTemplateQueryKey(options)
    });
};

export const importNetworkFromTemplateQueryKey = (options: Options<ImportNetworkFromTemplateData>) => createQueryKey('importNetworkFromTemplate', options);

/**
 * Import network from template
 * Create a new network from a template with organization and node mappings. Supports both Fabric and Besu templates, with optional chaincode/smart contract definitions.
 */
export const importNetworkFromTemplateOptions = (options: Options<ImportNetworkFromTemplateData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await importNetworkFromTemplate({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: importNetworkFromTemplateQueryKey(options)
    });
};
 ...
 * Create a new network from a template with organization and node mappings. Supports both Fabric and Besu templates, with optional chaincode/smart contract definitions.
 */
export const importNetworkFromTemplateMutation = (options?: Partial<Options<ImportNetworkFromTemplateData>>): UseMutationOptions<ImportNetworkFromTemplateResponse, ImportNetworkFromTemplateError, Options<ImportNetworkFromTemplateData>> => {
    const mutationOptions: UseMutationOptions<ImportNetworkFromTemplateResponse, ImportNetworkFromTemplateError, Options<ImportNetworkFromTemplateData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await importNetworkFromTemplate({
                ...options,
                ...localOptions,
...
export const validateTemplateImportQueryKey = (options: Options<ValidateTemplateImportData>) => createQueryKey('validateTemplateImport', options);

/**
 * Validate template import
 * Validate a template import request and get a preview of what would be created. Supports both Fabric and Besu templates.
 */
export const validateTemplateImportOptions = (options: Options<ValidateTemplateImportData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await validateTemplateImport({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: validateTemplateImportQueryKey(options)
    });
};
 ...
 * Validate a template import request and get a preview of what would be created. Supports both Fabric and Besu templates.
 */
export const validateTemplateImportMutation = (options?: Partial<Options<ValidateTemplateImportData>>): UseMutationOptions<ValidateTemplateImportResponse, ValidateTemplateImportError, Options<ValidateTemplateImportData>> => {
    const mutationOptions: UseMutationOptions<ValidateTemplateImportResponse, ValidateTemplateImportError, Options<ValidateTemplateImportData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await validateTemplateImport({
                ...options,
                ...localOptions,
...
export const getNodeGroupsQueryKey = (options?: Options<GetNodeGroupsData>) => createQueryKey('getNodeGroups', options);

/**
 * List node groups
 */
export const getNodeGroupsOptions = (options?: Options<GetNodeGroupsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getNodeGroupsQueryKey(options)
    });
};

export const postNodeGroupsQueryKey = (options: Options<PostNodeGroupsData>) => createQueryKey('postNodeGroups', options);

/**
 * Create a node group
 */
export const postNodeGroupsOptions = (options: Options<PostNodeGroupsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroups({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsQueryKey(options)
    });
};
 ...
 * Create a node group
 */
export const postNodeGroupsMutation = (options?: Partial<Options<PostNodeGroupsData>>): UseMutationOptions<PostNodeGroupsResponse, DefaultError, Options<PostNodeGroupsData>> => {
    const mutationOptions: UseMutationOptions<PostNodeGroupsResponse, DefaultError, Options<PostNodeGroupsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroups({
                ...options,
                ...localOptions,
 ...
 * Delete a node group
 */
export const deleteNodeGroupsByIdMutation = (options?: Partial<Options<DeleteNodeGroupsByIdData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteNodeGroupsByIdData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteNodeGroupsByIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteNodeGroupsById({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getNodeGroupsByIdQueryKey = (options: Options<GetNodeGroupsByIdData>) => createQueryKey('getNodeGroupsById', options);

/**
 * Get a node group
 */
export const getNodeGroupsByIdOptions = (options: Options<GetNodeGroupsByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNodeGroupsById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNodeGroupsByIdQueryKey(options)
    });
};

export const getNodeGroupsByIdChildrenQueryKey = (options: Options<GetNodeGroupsByIdChildrenData>) => createQueryKey('getNodeGroupsByIdChildren', options);

/**
 * List child nodes of a group
 * Returns the nodes owned by this group in canonical role order
 * (the same order StartGroup uses). For a committer that's
 * sidecar → coordinator → validator → verifier → query; for an
 * orderer group it's router → batcher → consenter → assembler.
 */
export const getNodeGroupsByIdChildrenOptions = (options: Options<GetNodeGroupsByIdChildrenData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNodeGroupsByIdChildren({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNodeGroupsByIdChildrenQueryKey(options)
    });
};

export const postNodeGroupsByIdInitQueryKey = (options: Options<PostNodeGroupsByIdInitData>) => createQueryKey('postNodeGroupsByIdInit', options);

/**
 * Initialize a FabricX orderer group
 * Generates crypto, writes on-disk config, persists deployment_config on the group,
 * and creates one child nodes row per role (router, batcher, consenter, assembler).
 * Only valid for FABRICX_ORDERER_GROUP groups. Idempotency: fails if already initialized.
 */
export const postNodeGroupsByIdInitOptions = (options: Options<PostNodeGroupsByIdInitData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroupsByIdInit({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsByIdInitQueryKey(options)
    });
};
 ...
 * Only valid for FABRICX_ORDERER_GROUP groups. Idempotency: fails if already initialized.
 */
export const postNodeGroupsByIdInitMutation = (options?: Partial<Options<PostNodeGroupsByIdInitData>>): UseMutationOptions<PostNodeGroupsByIdInitResponse, DefaultError, Options<PostNodeGroupsByIdInitData>> => {
    const mutationOptions: UseMutationOptions<PostNodeGroupsByIdInitResponse, DefaultError, Options<PostNodeGroupsByIdInitData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroupsByIdInit({
                ...options,
                ...localOptions,
...
/**
 * Detach the postgres service pointer from a node group
 * Clears node_groups.postgres_service_id. The underlying service is
 * NOT stopped — use POST /services/{id}/stop for that.
 */
export const deleteNodeGroupsByIdPostgresServiceMutation = (options?: Partial<Options<DeleteNodeGroupsByIdPostgresServiceData>>): UseMutationOptions<DeleteNodeGroupsByIdPostgresServiceResponse, DefaultError, Options<DeleteNodeGroupsByIdPostgresServiceData>> => {
    const mutationOptions: UseMutationOptions<DeleteNodeGroupsByIdPostgresServiceResponse, DefaultError, Options<DeleteNodeGroupsByIdPostgresServiceData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteNodeGroupsByIdPostgresService({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
/**
 * Attach an existing postgres service to a node group
 * Sets node_groups.postgres_service_id. The service must already exist
 * (create it via POST /services/postgres). Only FABRICX_COMMITTER groups
 * accept postgres services.
 */
export const putNodeGroupsByIdPostgresServiceMutation = (options?: Partial<Options<PutNodeGroupsByIdPostgresServiceData>>): UseMutationOptions<PutNodeGroupsByIdPostgresServiceResponse, DefaultError, Options<PutNodeGroupsByIdPostgresServiceData>> => {
    const mutationOptions: UseMutationOptions<PutNodeGroupsByIdPostgresServiceResponse, DefaultError, Options<PutNodeGroupsByIdPostgresServiceData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await putNodeGroupsByIdPostgresService({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const postNodeGroupsByIdRestartQueryKey = (options: Options<PostNodeGroupsByIdRestartData>) => createQueryKey('postNodeGroupsByIdRestart', options);

/**
 * Restart a node group
 */
export const postNodeGroupsByIdRestartOptions = (options: Options<PostNodeGroupsByIdRestartData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroupsByIdRestart({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsByIdRestartQueryKey(options)
    });
};
 ...
 * Restart a node group
 */
export const postNodeGroupsByIdRestartMutation = (options?: Partial<Options<PostNodeGroupsByIdRestartData>>): UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdRestartData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdRestartData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroupsByIdRestart({
                ...options,
                ...localOptions,
...
export const getNodeGroupsByIdServicesQueryKey = (options: Options<GetNodeGroupsByIdServicesData>) => createQueryKey('getNodeGroupsByIdServices', options);

/**
 * List services attached to a node group
 */
export const getNodeGroupsByIdServicesOptions = (options: Options<GetNodeGroupsByIdServicesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNodeGroupsByIdServices({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNodeGroupsByIdServicesQueryKey(options)
    });
};

export const postNodeGroupsByIdServicesPostgresQueryKey = (options: Options<PostNodeGroupsByIdServicesPostgresData>) => createQueryKey('postNodeGroupsByIdServicesPostgres', options);

/**
 * Attach a managed PostgreSQL service to a node group
 */
export const postNodeGroupsByIdServicesPostgresOptions = (options: Options<PostNodeGroupsByIdServicesPostgresData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroupsByIdServicesPostgres({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsByIdServicesPostgresQueryKey(options)
    });
};
 ...
 * Attach a managed PostgreSQL service to a node group
 */
export const postNodeGroupsByIdServicesPostgresMutation = (options?: Partial<Options<PostNodeGroupsByIdServicesPostgresData>>): UseMutationOptions<PostNodeGroupsByIdServicesPostgresResponse, DefaultError, Options<PostNodeGroupsByIdServicesPostgresData>> => {
    const mutationOptions: UseMutationOptions<PostNodeGroupsByIdServicesPostgresResponse, DefaultError, Options<PostNodeGroupsByIdServicesPostgresData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroupsByIdServicesPostgres({
                ...options,
                ...localOptions,
...
export const postNodeGroupsByIdStartQueryKey = (options: Options<PostNodeGroupsByIdStartData>) => createQueryKey('postNodeGroupsByIdStart', options);

/**
 * Start all children in a node group
 */
export const postNodeGroupsByIdStartOptions = (options: Options<PostNodeGroupsByIdStartData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroupsByIdStart({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsByIdStartQueryKey(options)
    });
};
 ...
 * Start all children in a node group
 */
export const postNodeGroupsByIdStartMutation = (options?: Partial<Options<PostNodeGroupsByIdStartData>>): UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdStartData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdStartData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroupsByIdStart({
                ...options,
                ...localOptions,
...
export const postNodeGroupsByIdStopQueryKey = (options: Options<PostNodeGroupsByIdStopData>) => createQueryKey('postNodeGroupsByIdStop', options);

/**
 * Stop all children in a node group
 */
export const postNodeGroupsByIdStopOptions = (options: Options<PostNodeGroupsByIdStopData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postNodeGroupsByIdStop({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postNodeGroupsByIdStopQueryKey(options)
    });
};
 ...
 * Stop all children in a node group
 */
export const postNodeGroupsByIdStopMutation = (options?: Partial<Options<PostNodeGroupsByIdStopData>>): UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdStopData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostNodeGroupsByIdStopData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postNodeGroupsByIdStop({
                ...options,
                ...localOptions,
...
export const getNodesReadinessBesuQueryKey = (options?: Options<GetNodesReadinessBesuData>) => createQueryKey('getNodesReadinessBesu', options);

/**
 * Check Besu readiness
 * Check if Java and Besu are installed and ready for deployment
 */
export const getNodesReadinessBesuOptions = (options?: Options<GetNodesReadinessBesuData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getNodesReadinessBesu({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getNodesReadinessBesuQueryKey(options)
    });
};
...
/**
 * Deploy a chaincode definition
 * Deploy a chaincode definition using Docker
 */
...
export const getServicesInfiniteOptions = (options?: Options<GetServicesData>) => {
    return infiniteQueryOptions<GetServicesResponse, DefaultError, InfiniteData<GetServicesResponse>, QueryKey<Options<GetServicesData>>, number | Pick<QueryKey<Options<GetServicesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
...
export const postServicesPostgresQueryKey = (options: Options<PostServicesPostgresData>) => createQueryKey('postServicesPostgres', options);

/**
 * Create a POSTGRES service
 */
export const postServicesPostgresOptions = (options: Options<PostServicesPostgresData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postServicesPostgres({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postServicesPostgresQueryKey(options)
    });
};
 ...
 * Create a POSTGRES service
 */
export const postServicesPostgresMutation = (options?: Partial<Options<PostServicesPostgresData>>): UseMutationOptions<PostServicesPostgresResponse, DefaultError, Options<PostServicesPostgresData>> => {
    const mutationOptions: UseMutationOptions<PostServicesPostgresResponse, DefaultError, Options<PostServicesPostgresData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postServicesPostgres({
                ...options,
                ...localOptions,
 ...
 * Delete a service
 */
export const deleteServicesByIdMutation = (options?: Partial<Options<DeleteServicesByIdData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteServicesByIdData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteServicesByIdData>> = {
        mutationFn: async (localOptions) => {
...
export const getServicesByIdQueryKey = (options: Options<GetServicesByIdData>) => createQueryKey('getServicesById', options);

/**
 * Get a service
 */
export const getServicesByIdOptions = (options: Options<GetServicesByIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getServicesById({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getServicesByIdQueryKey(options)
    });
};
 ...
 * Update a service
 */
export const putServicesByIdMutation = (options?: Partial<Options<PutServicesByIdData>>): UseMutationOptions<PutServicesByIdResponse, DefaultError, Options<PutServicesByIdData>> => {
    const mutationOptions: UseMutationOptions<PutServicesByIdResponse, DefaultError, Options<PutServicesByIdData>> = {
        mutationFn: async (localOptions) => {
...
export const getServicesByIdConsumersQueryKey = (options: Options<GetServicesByIdConsumersData>) => createQueryKey('getServicesByIdConsumers', options);

/**
 * List consumers of a service
 * Returns node_groups that reference this service via postgres_service_id.
 * Empty response means the service has no consumers and can be safely deleted.
 */
export const getServicesByIdConsumersOptions = (options: Options<GetServicesByIdConsumersData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getServicesByIdConsumers({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getServicesByIdConsumersQueryKey(options)
    });
};

export const getServicesByIdLogsQueryKey = (options: Options<GetServicesByIdLogsData>) => createQueryKey('getServicesByIdLogs', options);

/**
 * Get container logs for a service
 * Returns the last N lines of the service's container logs. Tail capped server-side.
 * Returns an empty logs string when the service has never been started.
 */
export const getServicesByIdLogsOptions = (options: Options<GetServicesByIdLogsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getServicesByIdLogs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getServicesByIdLogsQueryKey(options)
    });
};

export const postServicesByIdPostgresDatabasesQueryKey = (options: Options<PostServicesByIdPostgresDatabasesData>) => createQueryKey('postServicesByIdPostgresDatabases', options);

/**
 * Provision databases inside a running POSTGRES service
 * Creates (or updates) one role + database per entry. Idempotent: re-runs safely update the password.
 */
export const postServicesByIdPostgresDatabasesOptions = (options: Options<PostServicesByIdPostgresDatabasesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await postServicesByIdPostgresDatabases({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: postServicesByIdPostgresDatabasesQueryKey(options)
    });
};
 ...
 * Creates (or updates) one role + database per entry. Idempotent: re-runs safely update the password.
 */
export const postServicesByIdPostgresDatabasesMutation = (options?: Partial<Options<PostServicesByIdPostgresDatabasesData>>): UseMutationOptions<unknown, DefaultError, Options<PostServicesByIdPostgresDatabasesData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostServicesByIdPostgresDatabasesData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postServicesByIdPostgresDatabases({
                ...options,
                ...localOptions,
...
/**
 * Start a service on a docker network
 */
 ...
 * Start a service on a docker network
 */
export const postServicesByIdStartMutation = (options?: Partial<Options<PostServicesByIdStartData>>): UseMutationOptions<PostServicesByIdStartResponse, DefaultError, Options<PostServicesByIdStartData>> => {
    const mutationOptions: UseMutationOptions<PostServicesByIdStartResponse, DefaultError, Options<PostServicesByIdStartData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postServicesByIdStart({
                ...options,
                ...localOptions,
 ...
 * Stop a service
 */
export const postServicesByIdStopMutation = (options?: Partial<Options<PostServicesByIdStopData>>): UseMutationOptions<unknown, DefaultError, Options<PostServicesByIdStopData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<PostServicesByIdStopData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await postServicesByIdStop({
                ...options,
                ...localOptions,
