...
export const postAiByProjectIdConversationsByConversationIdSummarizeQueryKey = (options: Options<PostAiByProjectIdConversationsByConversationIdSummarizeData>) => [
    createQueryKey('postAiByProjectIdConversationsByConversationIdSummarize', options)
];
